...
public class Estimation extends ActionBarActivity {
    ...
    private static final String TAG = Estimation.class.getSimpleName();
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(Estimation.this, "An error has occurred.\nError code: " + errorCode + "\nDescription: " + description, Toast.LENGTH_LONG).show();
                        }
                    });
                }
    ...
    public void doModels(final View view) {
        ...
        final Intent intent = new Intent(this, ModelSearch.class);
    ...
    public void doScanEstimation(final View view) {
    ...
    public void doConnectEstimation() {
        if (scioAddress == null) {
